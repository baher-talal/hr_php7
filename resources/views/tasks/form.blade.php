...
@section('content')
        ...
        <div class="page-content-wrapper">
            ...
            <div class="sbox animated fadeInRight">
                ...
                <div class="sbox-content">
                    ...
                    {!! Form::open(array('url'=>'tasks/save?return='.$return, 'class'=>'form-horizontal','files' => true )) !!}
                    <div class="col-md-12">
                        <fieldset><legend> Tasks @if(!$row['id']) <button class="addUser btn btn-info pull-right">Add User</button>@endif</legend>
                            ...
                            <div id="tasks">
                                ...
                                @if(!$row['id'])
                                    <div class="form-group hidethis " style="display:none;">
                                        <label for="Commitment Id" class=" control-label col-md-4 text-left"> Commitment Id <span class="asterix"> * </span></label>
                                        <div class="col-md-6">
                                                ...
                                                <div class="form-group  " >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <select name='tasktimeUser_0[]' required  class='form-control '>
    ...
    <script>
        ...
        $(document).on("click", ".addTask", function (event) {
            ...
            $(this).closest('.taskDetails').find('.task select').last().attr('name', "tasktime" + user + "[]");
        });
        ...
        $(document).on("click", ".addUser", function (event) {
            ...
            $('.taskDetails').last().find('.task select').each(function () {
