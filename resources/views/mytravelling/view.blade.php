...
<div class="page-content row">
    ...
    <div class="page-content-wrapper">   
        <div class="toolbar-line">
            <a href="{{ URL::to('mytravelling?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_back') }}"><i class="fa fa-arrow-circle-left"></i>&nbsp;{{ Lang::get('core.btn_back') }}</a>
            <!--			@if($access['is_add'] ==1)
                                    <a href="{{ URL::to('mytravelling/update/'.$id.'?return='.$return) }}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit"></i>&nbsp;{{ Lang::get('core.btn_edit') }}</a>
                                    @endif  		   	  -->
        </div>
...
<!--					<tr>
                        ...
                        <tr>
                            ...
                            <td>{!! SiteHelpers::gridDisplayView($row->want_visa,'want_visa','1:tb_yes_no:id:value') !!}  </td>
                        ...
                        <tr>
                            ...
                            <td> {{ $row->total_cost }}    @if(isset($currency))   {{$currency}}    @endif </td>
