    ...
    <div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content">
                ...
                {!! Form::open(array('url'=>'mytravelling/review?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
                <div class="col-md-12">
                    <fieldset>
  ...
  <div class="form-group" >
                        ...
                        <div class="form-group  " >
                            ...
                            <div class="col-md-6 emp_vacation_margin">
                                ...
                                {!! SiteHelpers::gridDisplayView($row->ceo_approve,'ceo_approve','1:tb_yes_no:id:value') !!}
                            </div> 
                            <div class="col-md-2">
