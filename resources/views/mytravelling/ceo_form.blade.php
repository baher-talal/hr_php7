...
<div class="page-content row">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content">
                ...
                {!! Form::open(array('url'=>'mytravelling/ceo?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
                <div class="col-md-12">
                    <fieldset>
  ...
  <div class="form-group" >
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-6 emp_vacation_margin">
                                {!! SiteHelpers::gridDisplayView($row->cfo_approve,'cfo_approve','1:tb_yes_no:id:value') !!}
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group  " >
                           ...
                           <div class="form-group  " >
                            <label for="Ceo Approve" class=" control-label col-md-4 text-left"> Ceo Approve  <span class="asterix"> * </span> </label>
                            <div class="col-md-6">

                                <label class='radio radio-inline'>
                                    <input type='radio' name='ceo_approve' value ='0'  required @if($row['ceo_approve'] == '0') checked="checked" @endif > No </label>
                                <label class='radio radio-inline'>
                                    <input type='radio' name='ceo_approve' value ='1' required  @if($row['ceo_approve'] == '1') checked="checked" @endif > Yes </label> 
                            </div> 
                            <div class="col-md-2">
