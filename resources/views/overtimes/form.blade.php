...
<div class="page-content row">
    ...
    <div class="page-header">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ URL::to('overtimes?return='.$return) }}">{{ $pageTitle }}</a></li>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content"> 	
                ...
                {!! Form::open(array('url'=>'overtimes/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
                <div class="col-md-12">
                    <fieldset><legend> overtimes</legend>
                        ...
                        <div class="form-group  " >
                            ...
                            <div class="col-md-6 emp_vacation_margin">
                                 {!! SiteHelpers::gridDisplayView($row->department_id,'department_id','1:tb_departments:id:title') !!}
                            </div> 
                            <div class="col-md-2">
                        ...
                        <div class="form-group  " >
                            ...
                            <div class="col-md-6 emp_vacation_margin">
                                 {!! SiteHelpers::gridDisplayView($row->manager_id,'manager_id','1:tb_users:id:first_name|last_name') !!}
                            </div>
                            <div class="col-md-2">
                           ...
                           <div class="form-group" >
                            <label for="Hours" class=" control-label col-md-4 text-left"> No Hours : </label>
                            <div class="col-md-6 emp_vacation_margin">
                                {{ $row->no_hours }}
                            </div> 
                            <div class="col-md-2">
                        ...
                        <div class="form-group  " >
                            <label for="Employee Reason" class=" control-label col-md-4 text-left"> Employee Reason </label>
                            <div class="col-md-6 emp_vacation_margin">
                                 {{ $row->employee_reason }}
                            </div> 
                            <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">	
                        ...
                        <button type="button" onclick="window.location.href ='{{ URL::to('overtimes?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
                    </div>	  
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#employee_id").jCombo("{{ URL::to('overtimes/comboselect?filter=tb_users:id:first_name|last_name') }}",
                {selected_value: '{{ $row["employee_id"] }}'});

        $("#department_id").jCombo("{{ URL::to('overtimes/comboselect?filter=tb_departments:id:title') }}",
                {selected_value: '{{ $row["department_id"] }}'});

        $("#manager_id").jCombo("{{ URL::to('overtimes/comboselect?filter=tb_users:id:first_name|last_name') }}",
