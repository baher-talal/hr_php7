...
<div class="page-content row">
    ...
    <div class="page-header">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ URL::to('employeespermissions?return='.$return) }}">{{ $pageTitle }}</a></li>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content"> 	
                ...
                {!! Form::open(array('url'=>'employeespermissions/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
                <div class="col-md-12">
                    <fieldset><legend> employees permissions</legend>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">	
                        ...
                        <button type="button" onclick="location.href ='{{ URL::to('employeespermissions?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
                    </div>	  
