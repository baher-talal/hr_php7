        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content">
                <div class="toolbar-line ">
                    @if($access['is_add'] ==1)
                    <a href="{{ URL::to('employeespermissions/update') }}" class="tips btn btn-sm btn-white"
                    ...
                    <a href="{{ URL::to('employeespermissions/download') }}" class="tips btn btn-sm btn-white"
                ...
                {!! Form::open(array('url'=>'employeespermissions/delete/', 'class'=>'form-horizontal' ,'id'
                =>'SximoTable' )) !!}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Yes
                                    @elseif( $field['field'] == "manager_approved" && $row->$x == 0 &&
                                    is_int($row->$x) )
                                    No
                                    @else
                                    {{--*/ $conn = (isset($field['conn']) ? $field['conn'] : array() ) /*--}}
                                ...
                                <td>
                                    ...
                                    <a href="{{ URL::to('employeespermissions/show/'.$row->id.'?return='.$return)}}"
                                        class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i
                                            class="fa  fa-search "></i></a>
                                    @endif
                                    @if($access['is_edit'] ==1 && $row->manager_approved === NULL )
                                    <a href="{{ URL::to('employeespermissions/update/'.$row->id.'?return='.$return) }}"
