        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content">
                <div class="toolbar-line ">
                    @if($access['is_add'] ==1)
                    <a href="{{ URL::to('employeesovertime/update') }}" class="tips btn btn-sm btn-white"
                    ...
                    <a href="{{ URL::to('employeesovertime/download') }}" class="tips btn btn-sm btn-white"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ URL::to('employeesovertime/show/'.$row->id.'?return='.$return)}}"
                                        class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i
                                            class="fa  fa-search "></i></a>
                                    @endif
                                    @if($access['is_edit'] ==1 && $row->manager_approved === NULL )
                                    <a href="{{ URL::to('employeesovertime/update/'.$row->id.'?return='.$return) }}"
