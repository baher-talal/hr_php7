		...
		<div class="sbox animated fadeInRight">
			...
			<div class="sbox-content">
				<div class="toolbar-line ">
					@if($access['is_add'] ==1)
					<a href="{{ URL::to('occationscategories/update') }}" class="tips btn btn-sm btn-white"
					...
					<a href="{{ URL::to('occationscategories/download') }}" class="tips btn btn-sm btn-white"
				...
				{!! Form::open(array('url'=>'occationscategories/delete/', 'class'=>'form-horizontal' ,'id'
				=>'SximoTable' )) !!}
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="{{ URL::to('occationscategories/show/'.$row->id.'?return='.$return)}}"
										class="tips btn btn-xs btn-white"
										title="{{ Lang::get('core.btn_view') }}"><i
											class="fa  fa-search "></i></a>
									@endif
									@if($access['is_edit'] ==1)
									<a href="{{ URL::to('occationscategories/update/'.$row->id.'?return='.$return) }}"
										class="tips btn btn-xs btn-white"
