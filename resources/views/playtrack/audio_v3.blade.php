...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{url('campaign/style/style3.css')}}" >
...
@if(isset($track[0]->tr_background_image))
.bg {
  /* The image used */
  background-image: url('{{url()."/".$track[0]->tr_background_image}}');
                    ...
                    <div id="chooseDevice">
                        <div id="vid">
                            <div class="img-size">
                                ...
                                @else
                                <video id="trackId"  width="100%" @if($track[0]->track_poster) poster="{{url($track[0]->track_poster)}}" @endif  controlsList="nodownload" controls  playsinline>
                                    <img src="{{url($track[0]->background_image)}}" alt="">
                                    <source src="{!! url($track[0]->track_file) !!}">
                                </video>
                                @endif
