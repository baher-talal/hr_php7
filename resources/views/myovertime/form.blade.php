...
<div class="page-content row">
    ...
    <div class="page-header">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ URL::to('myovertime?return='.$return) }}">{{ $pageTitle }}</a></li>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content"> 	
                ...
                {!! Form::open(array('url'=>'myovertime/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
                <div class="col-md-12">
                    <fieldset><legend> my overtime</legend>
                        ...
                        <div class="form-group  " >
                         ...
                         <div class="form-group  " >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group m-b" style="width:150px !important;">
                                    {!! Form::text('from', $row['from'],array('class'=>'form-control  datetimepicker_overtime','required'=>'required')) !!}
                        ...
                        <div class="form-group  " >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group m-b" style="width:150px !important;">
                                    {!! Form::text('to', $row['to'],array('class'=>'form-control  datetimepicker_overtime','required'=>'required')) !!}
                                    <span class="input-group-addon  datetimepicker_button"><i class="fa fa-calendar"></i></span>
                                </div> 
                            </div> 
                            <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <!--<button type="submit" name="apply" class="btn btn-info btn-sm" ><i class="fa  fa-check-circle"></i> {{ Lang::get('core.sb_apply') }}</button>-->
                        ...
                        <button type="button" onclick="location.href ='{{ URL::to('myovertime?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
                    </div>	  
