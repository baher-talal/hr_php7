    ...
    <div class="page-header">
 	...
 	<div class="page-content-wrapper">   
	   <div class="toolbar-line">
	   		<a href="{{ URL::to('mediaspecsdocument?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_back') }}"><i class="fa fa-arrow-circle-left"></i>&nbsp;{{ Lang::get('core.btn_back') }}</a>
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('mediaspecsdocument/update/'.$id.'?return='.$return) }}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit"></i>&nbsp;{{ Lang::get('core.btn_edit') }}</a>
			@endif  		   	  
		</div>
<div class="sbox animated fadeInRight">
	...
	<table class="table table-striped table-bordered" >
		<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>File Extension</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>File Size</td>
