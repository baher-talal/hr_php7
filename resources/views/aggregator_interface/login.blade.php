...
<div class="sbox container" style="width:30%;margin-top:7%">
	<div class="sbox-title">
				...
				<h3 >Aggregator <small> Interface </small></h3>
	...
	<div class="tab-content" >
		...
		<form method="post" action="{{ url('aggregator/login')}}" class="form-vertical">
	...
	<div class="tab-pane  m-t" id="tab-forgot">
		...
		<form method="post" action="{{ url('aggregator/password-reset')}}" class="form-vertical box" id="fr">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
