...
<div class="page-content row">
	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			...
			<li class="active"> {{ Lang::get('core.m_groups') }} </li>
		</ul>
	...
	<div class="page-content-wrapper m-t">
		<ul class="nav nav-tabs" style="margin-bottom:10px;">
			<li><a href="{{ URL::to('core/users')}}"><i class="fa fa-user"></i> {{ Lang::get('core.m_users') }} </a>
			</li>
			<li class="active"><a href="{{ URL::to('core/groups')}}"><i class="fa fa-users"></i>
		...
		<div class="sbox animated fadeIn">
			<!--<div class="sbox-title"> <h5> <i class="fa fa-table"></i> <?php //  echo $pageTitle; ?> </h5>
		<div class="sbox-tools" >
			...
			<div class="sbox-content">
				<div class="toolbar-line ">
					@if($access['is_add'] ==1)
					<a href="{{ URL::to('core/groups/update') }}" class="tips btn btn-sm btn-white"
					...
					<a href="{{ URL::to('core/groups/download') }}" class="tips btn btn-sm btn-white"
				...
				<div class="table-responsive" style="min-height:300px;">
					<table class="table table-striped ">
						<thead>
							<tr>
								<th class="number"> {{ Lang::get('core.Num' )  }} </th>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="{{ URL::to('core/groups/show/'.$row->group_id.'?return='.$return)}}"
										class="tips btn btn-xs btn-white"
										title="{{ Lang::get('core.btn_view') }}"><i
											class="fa  fa-search "></i></a>
									@endif
									@if($access['is_edit'] ==1)
									<a href="{{ URL::to('core/groups/update/'.$row->group_id.'?return='.$return) }}"
										class="tips btn btn-xs btn-white"
