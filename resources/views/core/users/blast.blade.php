...
<div class="page-content row">
 ...
 <div class="page-content-wrapper m-t">  
  <ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li ><a href="{{ URL::to('core/users')}}"><i class="fa fa-user"></i> {{ Lang::get('core.m_users') }} </a></li>
    <li class=""><a href="{{ URL::to('core/groups')}}"><i class="fa fa-users"></i> {{ Lang::get('core.m_groups') }}</a></li>
    <li class="active"><a href="{{ URL::to('core/users/blast')}}"><i class="fa fa-envelope"></i> {{ Lang::get('core.m_sendmail') }} </a></li>
  </ul> 
...
<div class="col-sm-6">
          ...
          <div class="col-md-9">          
            <label class="radio">
              <input type="radio" required  name="uStatus" value="all" > {{ Lang::get('core.fr_mallstatus') }}  
            </label>
            <label class="radio">
              <input type="radio" required name="uStatus" value="1" > {{ Lang::get('core.fr_mactive') }}  
            </label>  
            <label class="radio">
              <input type="radio" required name="uStatus" value="0" > {{ Lang::get('core.fr_munconfirmed') }}  
            </label>
            <label class="radio">
              <input type="radio" required name="uStatus" value="2"> {{ Lang::get('core.fr_mblocked') }}  
            </label>                                
           </div> 
          </div>  
</div>
 ...
 <div class="col-sm-12">
          ...
          <label for="ipt" class=" control-label col-md-3"> </label>
          <div class="col-md-9">
              <button type="submit" name="submit" class="btn btn-primary">{{ Lang::get('core.sb_send_mail') }} </button>
           </div> 
          </div> 
	</div>	                   
     {!! Form::close() !!}
