...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content">
		 ...
		 {!! Form::open(array('url'=>'individualproviders/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-3">
						<fieldset><legend> General</legend>
								  ...
								  <div class="form-group  " >
									<label for="Provider Type" class=" control-label col-md-4 text-left"> Provider Type <span class="asterix"> * </span></label>
									<div class="col-md-6">

					<input type='radio' name='provider_type_id' value ='1' checked required @if($row['provider_type_id'] == '1') checked="checked" @endif > Individual
									 </div>
									 <div class="col-md-2">
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					 	...
					 	<div >
						{!! SiteHelpers::showUploadedFile($row['provider_logo'],'/uploads/media/') !!}
			...
			<div class="col-md-3">
                  ...
                  <div class="form-group  " >
									...
									<div class="col-md-6">
                    <input type="password" name="provider_password" value="" class="form-control" autocomplete="off"> 
									 </div>
									 <div class="col-md-2">
			...
			<div class="col-md-3">
						<fieldset><legend> Bank and Legal</legend>
								  ...
								  <div class="form-group  " >
									<label for="Identity No" class=" control-label col-md-4 text-left"> Identity No <span class="asterix"> * </span></label>
									<div class="col-md-6">
									  {!! Form::text('provider_identity_no', $row['provider_identity_no'],array('class'=>'form-control', 'placeholder'=>'', 'required'=>'true'  )) !!}
									 </div>
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									<label for="Identity File" class=" control-label col-md-4 text-left"> Identity File </label>
									<div class="col-md-6">
									  <input  type='file' name='provider_identity_file' id='provider_identity_file' accept='.pdf, .jpg, .png' @if($row['provider_identity_file'] =='') class='required' @endif style='width:150px !important;'  />
					 	<div >
						{!! SiteHelpers::showUploadedFile($row['provider_identity_file'],'/uploads/media/') !!}
								  ...
								  <div class="form-group  " >
									<label for="Tax Card No" class=" control-label col-md-4 text-left"> Tax Card No </label>
									<div class="col-md-6">
									  {!! Form::text('provider_tax_card_no', $row['provider_tax_card_no'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
									 </div>
									 <div class="col-md-2">
					 	...
					 	<div >
						{!! SiteHelpers::showUploadedFile($row['provider_tax_card_file'],'/uploads/media/') !!}
			...
			<div style="clear:both"></div>
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('individualproviders?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>
