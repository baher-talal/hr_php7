                              ...
                              <table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
                                  ...
                                  @foreach($operators_tracks as $operators_track)
                                      <tr>
                                          ...
                                          <td>
                                              <label>{{$operators_track->operator->country->country}}/{{$operators_track->operator->name}}</label>
                                          </td>
                                          <td>
                                          ...
                                          <td class="visible-md visible-lg">
                                              <div class="btn-group">
                                                  ...
                                                  <a class="btn btn-sm btn-primary show-tooltip" title="" href="{{url("operator_track/$operators_track->id/edit")}}" data-original-title="Edit"><i class="fa fa-edit"></i></a>
